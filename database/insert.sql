...
INSERT INTO `menu`(name, price, description, image, cateId) VALUES ('Beef Noodle Soup', 40.50, 'Wonderfully fragrant and deliciously healthy, this simple Chinese Beef Noodle Soup makes the perfect warming meal.', '/images/menu/breefNoodleSoup.jpg', 1);
...
INSERT INTO `menu`(name, price, description, image, cateId) VALUES ('Mango and Sticky Rice', 80.00, 'Looking for dessert? Look no further than the all-time crowd pleaser of mango and sticky rice. Kao niew ma muang is simple but extremely delicious, made with sticky rice, fresh mango slices, and lashings of sweet condensed milk.', '/images/menu/mangoAndStickyRice', 5);
